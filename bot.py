...
def start_message(message):
       bot.send_message(message.chat.id, '''👋🏻 *Приветствуем Тебя в нaшем бoтe.*
                                     ...
                                     \nВсё честно и прозрачно, вот ссылка на пруф:\nhttps://t.me/joinchat/SktCRnU_3W4OAVWi
...
def send_message(message):
    if message.text == 'Доступ в приват':
        ...
        time.sleep(3)
        bot.send_message(message.chat.id, '*Платеж не был найден*', parse_mode= "Markdown") #🚫*Платеж не был найден*🚫
